...
const pageTitle = "Sign In - ZapMinds Academy";

useSeoMeta({
  title: pageTitle,
  ogTitle: pageTitle,
  ogUrl: config.public.siteBaseUrl + config.app.baseURL + "signin",
  ogType: "website",
  twitterCard: "summary",
  ...
  <div :class="$style.root">
    <div class="container">
      <div :class="$style.formContainer">
        ...
        <p :class="$style.subtitle">Sign in to your account</p>
        ...
        <form @submit="handleSubmit" :class="$style.form">
          ...
          <p :class="$style.linkText">
            ...
            <NuxtLink to="/signup" :class="$style.link">Sign Up</NuxtLink>
          </p>
        </form>
      </div>
    </div>
